...
{
    const uint8_t eth_dst[6] = { 0x3c, 0xfd, 0xfe, 0xa2, 0x1e, 0x3b };
    const uint8_t eth_src[6] = { 0x66, 0x93, 0xb6, 0x04, 0xbf, 0x7e };
    const uint8_t ip_dst[4] = { 192, 168, 100, 2 };
    const uint8_t ip_src[4] = { 192, 168, 100, 3 };
